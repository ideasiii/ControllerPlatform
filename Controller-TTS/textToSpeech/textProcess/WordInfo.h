...
//========================= 單位量詞===============================//
static std::vector<std::string> vWordUnit = { "斤", "分", "歲", "元", "噸", "吋", "呎", "磅", "盎司", "秒", "本", "樓", "次", "份", "台", "點", "棟",
		"輛", "隻", "支", "張", "個", "雙", "匹", "艘", "塊", "件", "名", "顆", "棵", "架", "頭", "戶", "套", "頂", "朵", "疊", "里", "坪" , "百", "千", "萬", "億", "兆"};

static std::vector<std::string> vWordUnitDouble = { "公克", "公斤", "公升", "公噸", "毫升", "毫克", "毫米", "公釐", "微米", "奈米", "公里", "公尺", "公分", "公頃", "英呎", "英尺", "英吋", "英寸",
		"台幣", "日幣", "美金", "韓元", "人民幣", "港幣"};

...
int CController::onCreated(void* nMsqKey)
{
	...
	{
		JSONObject obj;
		//JSONObject *tempObj = new JSONObject(VERY_LONG_JSON_STR);
		obj.create();
		obj.put("kgjkljslkjcsel", 234532);
		obj.put("srlcsaqjew4jwpwpeo", 2432423.66666);
		obj.put("aaaaaaa", R"(asdfgetrlur53454 "important" 444555)");
		//obj.putSerialized("bbbbbbbbb", *tempObj);

		//tempObj->release();
		//delete tempObj;

		printf("obj.toUnformattedString() = %s\n", obj.toUnformattedString().c_str());
		printf("obj.toJSON()              = %s\n", obj.toJSON().c_str());

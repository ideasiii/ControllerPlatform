...
static map<int, string> mapCommand = create_map<int, string>( generic_nack,
		"generic_nack")( bind_request, "bind_request")( bind_response,
		"bind_response")(
authentication_request, "authentication_request")( authentication_response,
		"authentication_response")(
access_log_request, "access_log_request")( access_log_response,
		"access_log_response")( enquire_link_request, "enquire_link_request")(
enquire_link_response, "enquire_link_response")( unbind_request,
		"unbind_request")(
...
config_response, "config_response")( power_port_set_request,
		"power_port_request")( power_port_set_response, "power_port_response")(
...
mdm_login_request, "mdm_login_request")(
mdm_login_response, "mdm_login_response")( mdm_operate_request,
		"mdm_operate_request")(
mdm_operate_response, "mdm_operate_response")(
sdk_tracker_request, "sdk_tracker_request")( sdk_tracker_response,
		"sdk_tracker_response");

static map<int, string> mapStatus = create_map<int, string>\
( STATUS_ROK,
		"No Error")( STATUS_RINVMSGLEN, "Message Length is invalid")(
STATUS_RINVCMDLEN, "Command Length is invalid")( STATUS_RINVCMDID,
		"Invalid Command ID")( STATUS_RINVBNDSTS,
		"Incorrect BIND Status for given command")( STATUS_RALYBND,
		"Already in Bound State")( STATUS_RSYSERR, "System Error")(
STATUS_RBINDFAIL, "Bind Failed")( STATUS_RPPSFAIL, "Power Port Setting Fail")(
STATUS_RINVBODY, "Invalid Packet Body Data")( STATUS_RINVCTRLID,
		"Invalid Controller ID")(
STATUS_RINVJSON, "Invalid JSON Data")( STATUS_ROPERATE, "MDM operate notify")(
STATUS_RMDMLOGINFAIL, "MDM Login fail, no token")(STATUS_RAUTHFAIL,
		"Authentication Fail");

__attribute__ ((unused)) static void printPacket(int nCommand, int nStatus,
		int nSequence, int nLength, const char * szDesc, int nClienFD = 0) {
	char szCmd[48];
	char szSta[32];
	...
	_log(
			"%s CMP : Command=%-20s Status=%-20s Sequence=%d Length=%d [Socket FD=%d]",
			szDesc, szCmd, szSta, nSequence, nLength, nClienFD);
}

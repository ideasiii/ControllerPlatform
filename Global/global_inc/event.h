...
enum _EVENT_FILTER
{
	CONTROLLER = 1, SOCKET_SERVER = 5000, SOCKET_CLIENT = 6000
};
...
enum _EVENT_COMMAND
{
	...
	EVENT_THREAD_EXIT,
	EVENT_SOCKET_ACCEPT,
	EVENT_SOCKET_SERVER_RECEIVE,
	EVENT_SOCKET_CLIENT_RECEIVE,
	EVENT_SERVER_DOMAIN,
	EVENT_SERVER_TCP,
	EVENT_SERVER_UDP,
	...
	EVENT_RECONNECT_MONGODB

};

#define EVENT_COMMAND														1000
#define EVENT_COMMAND_TIMER													(EVENT_COMMAND + EVENT_TIMER)
#define EVENT_COMMAND_THREAD_EXIT											(EVENT_COMMAND + EVENT_THREAD_EXIT)
#define EVENT_COMMAND_SOCKET_ACCEPT											(EVENT_COMMAND + EVENT_SOCKET_ACCEPT)
#define EVENT_COMMAND_SOCKET_SERVER_RECEIVE									(EVENT_COMMAND + EVENT_SOCKET_SERVER_RECEIVE)
#define EVENT_COMMAND_SOCKET_CLIENT_RECEIVE									(EVENT_COMMAND + EVENT_SOCKET_CLIENT_RECEIVE)
...
#define EVENT_COMMAND_RECONNECT_CONTROLLER_MONGODB							(EVENT_COMMAND + EVENT_RECONNECT_MONGODB)
...
enum _MSQ_KEY
{
	MSQ_KEY_CONTROLLER_DISPATCHER = 1,
	MSQ_KEY_CONTROLLER_SIGNIN,
	MSQ_KEY_CONTROLLER_MONGODB,
	MSQ_KEY_CONTROLLER_AMX,
	MSQ_KEY_CONTROLLER_TRANSFER
};
